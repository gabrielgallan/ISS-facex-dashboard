			...
			<Table>
				<TableHeader className="bg-muted/55">
					<TableRow>
						...
						<TableHead>{t('dashboards.demographic.breakdown_table.columns.emotion')}</TableHead>
				...
				<TableBody>
					{emotionBreakdownMock.map((item, index) => (
						<TableRow key={item.key}>
							...
							<TableCell className="text-right">
								<div className="flex items-center justify-end gap-2">
									<div className="h-2 w-28 overflow-hidden rounded-xs bg-muted">
										<div
